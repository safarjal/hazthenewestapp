...
//                    FutureDateType(makeInstant(2022, 3, 26), TypesOfFutureDates.IHTIYATI_GHUSL)
    ...
    @Test
    fun testBugMaslaIssue217() {
        val entries = mutableListOf<Entry>()
        entries +=
            Entry(makeInstant(2022, 10, 12),
                makeInstant(2022, 10, 20))//12 oct to 20oct
        entries +=
            Entry(makeInstant(2022, 11, 17),
                makeInstant(2022, 11, 24))//17 nov to 24nov
        entries +=
            Entry(makeInstant(2023, 8, 3),
                makeInstant(2023, 11, 2))//3 aug 2023 to 2 nov
        val output = handleEntries(AllTheInputs(
            entries,
            typeOfMasla = TypesOfMasla.NIFAS,
            pregnancy = Pregnancy(
                makeInstant(2022, 11, 25 ),
                makeInstant(2023, 8, 3),
                25.getMilliDays(),
                mustabeenUlKhilqat = true)
        ))
        val expectedEndingOutputValues =
            EndingOutputValues(
                false,
                AadatsOfHaizAndTuhr(parseDays("7")!!,parseDays("28")!!,parseDays("25")!!),
                mutableListOf(
    ...
    fun testBugMaslaIssue222() {
        ...
        val expectedEndingOutputValues =
            EndingOutputValues(
                true,
                AadatsOfHaizAndTuhr(parseDays("10")!!,parseDays("21")!!),
                mutableListOf(
                    FutureDateType(makeInstant(2024, 1, 5), TypesOfFutureDates.END_OF_AADAT_TUHR),
                )
            )
        assertEquals(expectedEndingOutputValues.aadats!!.aadatHaiz.getDays(), output.endingOutputValues.aadats!!.aadatHaiz.getDays())
        assertEquals(expectedEndingOutputValues.aadats!!.aadatTuhr.getDays(), output.endingOutputValues.aadats!!.aadatTuhr.getDays())
...
//                    FutureDateType(makeInstant(2022, 4, 10), TypesOfFutureDates.IC_FORBIDDEN_DATE),
    ...
    fun testingMubtadiaFinalOutputsCase8a() {
        ...
        val entries = mutableListOf<Entry>()//40 days haiz
        entries +=
        ...
        val expectedEndingOutputValues =
            EndingOutputValues(
                true,
                AadatsOfHaizAndTuhr(10*MILLISECONDS_IN_A_DAY, -1L),
                mutableListOf(
    ...
    fun testingMubtadiaDurationCase2a() {
        ...
        val expectedAadats = AadatsOfHaizAndTuhr(10*MILLISECONDS_IN_A_DAY,-1)
