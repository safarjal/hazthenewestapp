...
object Styles {
    ...
    const val TABLE_DOUBLE_CELL_STYLE = "float: left; width:60px; height:24px; text-align:center; padding: 6px 0 0 0"
    ...
    const val TABLE_DOUBLE_CELL_BORDER_STYLE = "float: left; width:58px; height:22px; text-align:center; padding: 6px 0 0 0; border: 1px solid black"
    ...
    const val EMPTY_DOUBLE_CELL_STYLE = "float: left; width:60px; height:15px;"
