...
val urduStrings = Strings(
    "${UnicodeChars.ROSE}<b><span class='invisible'>*</span>جواب ::<span class='invisible'>*</span></b>\n\n",
    ...
    "<b><span class='invisible'>*</span>واللہ تعالی اعلم بالصواب<span class='invisible'>*</span></b>\n\n",
    ...
    "اگر خون اسی طرح جاری رہے یا فی الحال بند ہوجائے لیکن پندرہ دن کی کامل پاکی نہیں ملی کہ دوبارہ خون یا دھبہ آگیا تب پھر<b> date1<span class='invisible'>*</span> کو ضرور دوبارہ پوچھ لیں، اس لیے کہ مسئلہ کی صورت بدل جائے گی۔<span class='invisible'>*</span></b>\n\n",
    "اگر خون اسی طرح جاری رہے تب پھر<b><span class='invisible'>*</span> date1 تک آپ کے حیض کے دن ہونگے۔<span class='invisible'>*</span></b>\n\n",
    "حمل سے پہلے اس ترتیب سے خون آیا اور پاکی ملی:\n\n",
    "\n<b><span class='invisible'>*</span>حمل<span class='invisible'>*</span></b>\n",
    "\n<b><span class='invisible'>*</span>ولادت date1<span class='invisible'>*</span></b>\n",
    "\n<b><span class='invisible'>*</span>ولادت کے بعد اس ترتیب سے خون آیااور پاکی ملی<span class='invisible'>*</span>:</b>\n",
    "\n<b><span class='invisible'>*</span>date1 کو اسقاط ہوا (غیر مستبین الخلقہ)<span class='invisible'>*</span></b>\n",
    ...
    "اگر خون اسی طرح جاری رہے یا فی الحال بند ہوجائے لیکن پندرہ دن کی کامل پاکی نہیں ملی کہ دوبارہ خون یا دھبہ آگیا تب پھر<b><span class='invisible'>*</span> date1 تک آپ کے یقینی پاکی کے دن ہونگے۔<span class='invisible'>*</span></b>\n\n",
    "${UnicodeChars.GREEN_CIRCLE} <b><span class='invisible'>*</span>عادت:: حیض: duration1، طہر: duration2<span class='invisible'>*</span></b>\n\n",
    ...
    "${UnicodeChars.RAINBOW} <b><span class='invisible'>*</span>مسئلہ کا حل ::<span class='invisible'>*</span></b>\n\n",
...
val englishStrings = Strings(
    "${UnicodeChars.ROSE}<b><span class='invisible'>*</span>Answer::<span class='invisible'>*</span></b>\n\n",
    ...
    "<b><span class='invisible'>*</span>And Allah Ta’ala knows the best.<span class='invisible'>*</span></b>\n\n",
    ...
    "In case this bleeding continues without gap, or, it continues with gaps less than 15 days at a stretch, then <b><span class='invisible'>*</span>kindly do contact us again on date1 as the current ruling may change accordingly.<span class='invisible'>*</span></b>\n\n",
    "If the bleeding continues, then <b><span class='invisible'>*</span>till date1 will be the days of your period.<span class='invisible'>*</span></b>\n\n",
    "The bleeding and tuh’r has been in the following sequence before pregnancy:\n\n",
    "\nPregnancy\n",
    "\n<b><span class='invisible'>*</span>Date of delivery: date1<span class='invisible'>*</span></b>\n",
    "\n<b><span class='invisible'>*</span>The bleeding and tuh’r has been in the following sequence after delivery:<span class='invisible'>*</span></b>\n",
    "\n<b><span class='invisible'>*</span>Miscarriage of an undeveloped fetus confirmed on date1<span class='invisible'>*</span></b>\n",
    ...
    "In case this bleeding continues without gap, or, it continues with gaps less than 15 days at a stretch, then <b><span class='invisible'>*</span>till date1 are the days of your definitive purity.<span class='invisible'>*</span></b>\n\n",
    ...
    "${UnicodeChars.RAINBOW} <b><span class='invisible'>*</span>Solution::<span class='invisible'>*</span></b>\n\n",
