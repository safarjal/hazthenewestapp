...
val urduStrings = Strings(
    ...
    "اگر date1 تک بھی خون جاری ہی رہے  تب بھی  date1 کو غسل کر کے اپنی عبادات شروع کر دیں۔\n\n",
...
val englishStrings = Strings(
    ...
    "If bleeding continues till date1, then you must do ghusl on date1 and begin your ibadaat.</b>\n\n",
    ...
    "${UnicodeChars.BLACK_SQUARE} If you performed your ghusl on date1 then the salahs after that were valid, if not, then the salahs before your next ghusl have to be made qadha of.\n\n",
